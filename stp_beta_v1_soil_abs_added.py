...
# =============================================================================
    ...
    df = pd.read_parquet('2024_01_13_master_test_combined_plant_sensor_soil_moisture_readings_data_all_soil_moisture_abs_rate_added.parquet.gzip').rename(columns={'name':'plant_name'})
